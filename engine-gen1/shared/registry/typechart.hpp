...
namespace Registry
{
    class TypeChart
    {
        ...
        private:
            ...
            std::unordered_map<std::string, MetaDefinition::MoveCategory> moveCategories;
        ...
        public:
            ...
            double getMultiplyer(const std::string_view attackerTypeName, const MetaDefinition::PokemonType& defenderType) const;
    };
}
